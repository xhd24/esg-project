...
const questions = {
  Environment: [
    ...
    // === 종합 ===
    {
      id: 43,
      category: "Environment",
      subCategory: "Environmental-Overall",
  ...
  Social: [
    ...
    // === 사회공헌 (5문항) ===
    {
      id: 36,
      category: "Social",
      subCategory: "Social-Contribution",
    ...
    },
    {
      id: 44,
      category: "Social",
      subCategory: "Customer-Responsibility",
  ...
  Governance: [
    // === 이사회: 구성, 활동, 성과 평가 (7문항) ===
    {
      ...
      category: "Governance",
      subCategory: "Board",
      text: "이사회 구성 및 선임 절차가 투명하게 공개되어 있습니까?",
      description: "OECD 지배구조 원칙은 이사회 구성과 선임 절차의 투명성을 요구합니다.",
      options: ["예", "아니오"]
    },
    {
      id: 2,
      category: "Governance",
      subCategory: "Board",
      text: "이사의 임기 제한이나 재임 절차가 명확히 규정되어 있습니까?",
      description: "지속가능한 경영을 위해 이사 장기집권을 방지하는 제도가 필요합니다.",
      options: ["예", "아니오"]
    },
    {
      id: 3,
      category: "Governance",
      subCategory: "Board",
      text: "이사회 구성 시 성별, 연령, 배경 등 다양성을 고려합니까?",
      description: "OECD 및 글로벌 가이드라인은 이사회의 다양성을 강조합니다.",
      options: ["예", "아니오"]
    },
    {
      id: 4,
      category: "Governance",
      subCategory: "Board",
      text: "사외이사의 독립성을 보장하기 위한 제도를 운영합니까?",
      description: "사외이사의 독립성은 경영진 견제 기능 강화의 핵심입니다.",
      options: ["예", "아니오"]
    },
    {
      id: 5,
      category: "Governance",
      subCategory: "Board",
      text: "이사회 산하 위원회(감사위원회, 보상위원회 등)를 운영합니까?",
      description: "전문 위원회를 통한 이사회 견제와 균형 확보가 글로벌 스탠다드입니다.",
      options: ["예", "아니오"]
    },
    {
      id: 6,
      category: "Governance",
      subCategory: "Board",
      text: "이사회 활동과 성과를 정기적으로 평가합니까?",
      description: "이사회 성과평가는 지배구조의 효과성과 책임성을 확보하기 위함입니다.",
      options: ["예", "아니오"]
    },
    {
      id: 7,
      category: "Governance",
      subCategory: "Board",
      text: "경영진 보상에 ESG 목표 달성 여부가 반영됩니까?",
      description: "GRI 지침은 보상체계에 지속가능성 목표 연계를 권장합니다.",
      options: ["예", "아니오"]
    },
    // === 주주보호: 주주권 행사, 이익 보호 (4문항) ===
    {
      id: 8,
      category: "Governance",
      subCategory: "Shareholder Protection",
      text: "주주총회 소집 및 통보 절차를 법정기한 내에 준수합니까?",
      description: "상법은 주주총회의 적법한 소집과 통보 절차를 규정하고 있습니다.",
      options: ["예", "아니오"]
    },
    {
      id: 9,
      category: "Governance",
      subCategory: "Shareholder Protection",
      text: "전자투표 등 주주 의결권 행사 편의를 제공합니까?",
      description: "소수주주 권리 강화를 위해 전자투표 제도가 권장됩니다.",
      options: ["예", "아니오"]
    },
    {
      id: 10,
      category: "Governance",
      subCategory: "Shareholder Protection",
      text: "계열사와의 내부거래를 투명하게 공개하고 있습니까?",
      description: "공정거래법은 계열사 내부거래의 공정성과 투명성을 강조합니다.",
      options: ["예", "아니오"]
    },
    {
      id: 11,
      category: "Governance",
      subCategory: "Shareholder Protection",
      text: "지배주주와 회사 간 자기거래를 통제할 수 있는 제도가 있습니까?",
      description: "대주주와의 거래는 소액주주 이익 보호를 위해 관리되어야 합니다.",
      options: ["예", "아니오"]
    },
    // === 윤리: 경영부분 (6문항) ===
    {
      id: 12,
      category: "Governance",
      subCategory: "Ethics Management",
      text: "윤리경영을 추진하는 전담 조직이 존재합니까?",
      description: "윤리경영을 위한 전담 조직은 글로벌 기업 거버넌스 표준입니다.",
      options: ["예", "아니오"]
    },
    {
      id: 13,
      category: "Governance",
      subCategory: "Ethics Management",
      text: "임직원에게 윤리헌장 또는 행동규범을 제정하여 공유합니까?",
      description: "OECD 가이드라인은 임직원의 윤리규범 공유를 요구합니다.",
      options: ["예", "아니오"]
    },
    {
      id: 14,
      category: "Governance",
      subCategory: "Ethics Management",
      text: "정기적으로 윤리경영 및 준법 교육을 실시합니까?",
      description: "UN Global Compact는 정기적 교육을 통한 윤리 내재화를 강조합니다.",
      options: ["예", "아니오"]
    },
    {
      id: 15,
      category: "Governance",
      subCategory: "Ethics Management",
      text: "고위 경영진의 비윤리적 행위에 대해 엄격한 책임을 묻습니까?",
      description: "윤리적 책임성은 글로벌 거버넌스 원칙의 핵심입니다.",
      options: ["예", "아니오"]
    },
    {
      id: 16,
      category: "Governance",
      subCategory: "Ethics Management",
      text: "이사회 의장과 CEO 역할을 분리하여 운영합니까?",
      description: "OECD 원칙은 이사회 의장과 CEO의 역할 분리를 권장합니다.",
      options: ["예", "아니오"]
    },
    {
      id: 17,
      category: "Governance",
      subCategory: "Ethics Management",
      text: "경영 의사결정 시 윤리적 기준을 최우선으로 고려합니까?",
      description: "윤리적 의사결정은 기업 평판과 직결됩니다.",
      options: ["예", "아니오"]
    },
    // === 윤리: 내부통제부분 (3문항) ===
    {
      id: 18,
      category: "Governance",
      subCategory: "Ethics Internal Control",
      text: "임직원의 비윤리행위를 신고할 수 있는 내부 제보 채널이 있습니까?",
      description: "공익신고자 보호법은 제보 시스템 구축과 보호 장치를 의무화합니다.",
      options: ["예", "아니오"]
    },
    {
      id: 19,
      category: "Governance",
      subCategory: "Ethics Internal Control",
      text: "내부 제보자의 익명성과 불이익 방지 장치가 마련되어 있습니까?",
      description: "제보자 보호는 윤리경영 실효성 확보의 핵심입니다.",
      options: ["예", "아니오"]
    },
    {
      id: 20,
      category: "Governance",
      subCategory: "Ethics Internal Control",
      text: "임직원의 이해충돌 상황을 신고할 수 있는 절차가 마련되어 있습니까?",
      description: "OECD 가이드라인은 이해충돌 방지 체계를 요구합니다.",
      options: ["예", "아니오"]
    },
    // === 준법: 경영부분 (16문항) ===
    {
      ...
      text: "컴플라이언스 전담 조직이 설치되어 있습니까?",
      description: "ISO 37301(Compliance Management)은 전담 조직 운영을 권장합니다.",
      options: ["예", "아니오"]
    },
    {
      id: 22,
      category: "Governance",
      subCategory: "Compliance Management",
      text: "부패방지법, 공정거래법 등 주요 법규 준수 지침을 운영합니까?",
      description: "주요 법규 준수는 기업의 법적 리스크를 최소화합니다.",
      options: ["예", "아니오"]
    },
    {
      id: 23,
      category: "Governance",
      subCategory: "Compliance Management",
      text: "공정거래 자율준수 프로그램(CP)을 운영합니까?",
      description: "공정거래위원회는 CP 운영을 권장하고 있습니다.",
      options: ["예", "아니오"]
    },
    {
      id: 24,
      category: "Governance",
      subCategory: "Compliance Management",
      text: "중요 의사결정 시 이해관계자 의견을 반영합니까?",
      description: "AA1000 Stakeholder Engagement는 이해관계자 의견 반영을 요구합니다.",
      options: ["예", "아니오"]
    },
    {
      id: 25,
      category: "Governance",
      subCategory: "Compliance Management",
      text: "기업 지배구조에 대한 외부 평가를 정기적으로 받습니까?",
      description: "글로벌 기업은 외부 평가를 통한 신뢰 확보를 권장합니다.",
      options: ["예", "아니오"]
    },
    {
      id: 26,
      category: "Governance",
      subCategory: "Compliance Management",
      text: "ESG 법규 및 규제 변화에 대응하는 체계를 보유합니까?",
      description: "법규 모니터링은 규제 리스크를 최소화합니다.",
      options: ["예", "아니오"]
    },
    {
      id: 27,
      category: "Governance",
      subCategory: "Compliance Management",
      text: "ESG 위원회나 전담 조직이 정기적으로 경영진에 보고합니까?",
      description: "GRI 가이드라인은 ESG 성과의 경영 보고를 요구합니다.",
      options: ["예", "아니오"]
    },
    {
      id: 28,
      category: "Governance",
      subCategory: "Compliance Management",
      text: "ESG 성과를 장기 전략과 연계합니까?",
      description: "장기 전략과 ESG 성과 연계는 지속가능성을 높입니다.",
      options: ["예", "아니오"]
    },
    {
      id: 29,
      category: "Governance",
      subCategory: "Compliance Management",
      text: "협력업체 선정 및 계약 과정에서 공정성을 보장합니까?",
      description: "공정거래법은 협력업체 선정 과정의 투명성을 요구합니다.",
      options: ["예", "아니오"]
    },
    {
      id: 30,
      category: "Governance",
      subCategory: "Compliance Management",
      text: "입찰 및 계약 과정에서 담합을 방지하는 제도가 있습니까?",
      description: "OECD 반부패 가이드라인은 담합 금지를 명시합니다.",
      options: ["예", "아니오"]
    },
    {
      id: 31,
      category: "Governance",
      subCategory: "Compliance Management",
      text: "기업의 사회적 책임과 투명 경영에 대해 외부 평가를 받습니까?",
      description: "GRI, DJSI 등 글로벌 평가 기관이 이를 요구합니다.",
      options: ["예", "아니오"]
    },
    {
      id: 32,
      category: "Governance",
      subCategory: "Compliance Management",
      text: "ESG 위원회에서 경영진 보상체계를 검토합니까?",
      description: "ESG 성과와 보상 연계는 글로벌 트렌드입니다.",
      options: ["예", "아니오"]
    },
    {
      id: 33,
      category: "Governance",
      subCategory: "Compliance Management",
      text: "중요 의사결정 이유를 이해관계자와 공유합니까?",
      description: "투명성 확보를 위해 의사결정 이유 공유가 필요합니다.",
      options: ["예", "아니오"]
    },
    {
      id: 34,
      category: "Governance",
      subCategory: "Compliance Management",
      text: "회사의 지속가능성과 관련된 장기 전략을 수립했습니까?",
      description: "GRI 102는 지속가능한 장기 전략 수립을 강조합니다.",
      options: ["예", "아니오"]
    },
    {
      id: 35,
      category: "Governance",
      subCategory: "Compliance Management",
      text: "경영진의 의사결정 시 이해관계자 이익을 균형 있게 고려합니까?",
      description: "지속가능경영은 다양한 이해관계자 이익의 균형을 요구합니다.",
      options: ["예", "아니오"]
    },
    {
      id: 36,
      category: "Governance",
      subCategory: "Compliance Management",
      text: "기업 지배구조 관련 국내외 가이드라인을 준수하려고 노력합니까?",
      description: "OECD, FSB 등 국제적 권고 준수 여부를 확인합니다.",
      options: ["예", "아니오"]
    },
    // === 준법: 내부통제부분 (19문항) ===
    {
      id: 37,
      category: "Governance",
      subCategory: "Compliance Internal Control",
      text: "기업 리스크를 전사적으로 식별·평가하는 절차를 보유합니까?",
      description: "COSO ERM 프레임워크는 전사적 리스크 관리 체계를 요구합니다.",
      options: ["예", "아니오"]
    },
    {
      id: 38,
      category: "Governance",
      subCategory: "Compliance Internal Control",
      text: "사업연속성 관리체계(BCM)를 도입했습니까?",
      description: "ISO 22301은 사업 연속성 관리 표준을 규정합니다.",
      options: ["예", "아니오"]
    },
    {
      id: 39,
      category: "Governance",
      subCategory: "Compliance Internal Control",
      text: "외환, 원자재 가격, 세무 등 주요 재무 리스크에 대응하고 있습니까?",
      description: "재무 리스크 대응은 기업의 안정성을 높입니다.",
      options: ["예", "아니오"]
    },
    {
      id: 40,
      category: "Governance",
      subCategory: "Compliance Internal Control",
      text: "정보보안을 총괄하는 위원회 또는 전담 임원을 두고 있습니까?",
      description: "ISO 27001은 정보보안 책임자를 지정할 것을 요구합니다.",
      options: ["예", "아니오"]
    },
    {
      id: 41,
      category: "Governance",
      subCategory: "Compliance Internal Control",
      text: "정기적으로 정보보안 교육을 시행합니까?",
      description: "정보보안 인식 제고는 사이버 위협 대응의 핵심입니다.",
      options: ["예", "아니오"]
    },
    {
      id: 42,
      category: "Governance",
      subCategory: "Compliance Internal Control",
      text: "정보보안 시스템에 대해 제3자 인증(모의해킹 등)을 받습니까?",
      description: "제3자 검증은 보안 체계 신뢰성을 강화합니다.",
      options: ["예", "아니오"]
    },
    {
      id: 43,
      category: "Governance",
      subCategory: "Compliance Internal Control",
      text: "개인정보 보호 체계를 운영하고 있습니까?",
      description: "개인정보보호법 및 GDPR은 개인정보 관리체계를 요구합니다.",
      options: ["예", "아니오"]
    },
    {
      id: 44,
      category: "Governance",
      subCategory: "Compliance Internal Control",
      text: "주요 경영 정보와 재무 정보를 주주에게 투명하게 공개합니까?",
      description: "GRI 102는 기업의 투명한 정보 공개를 요구합니다.",
      options: ["예", "아니오"]
    },
    {
      id: 45,
      category: "Governance",
      subCategory: "Compliance Internal Control",
      text: "ESG 성과를 담은 지속가능경영 보고서를 발간합니까?",
      description: "GRI Standards는 ESG 보고서 발간을 권고합니다.",
      options: ["예", "아니오"]
    },
    {
      id: 46,
      category: "Governance",
      subCategory: "Compliance Internal Control",
      text: "외부 감사인의 회계감사를 통해 재무제표를 검증받습니까?",
      description: "외부 회계감사는 기업 재무 투명성을 보장합니다.",
      options: ["예", "아니오"]
    },
    {
      id: 47,
      category: "Governance",
      subCategory: "Compliance Internal Control",
      text: "내부 감사 기능을 독립적으로 운영하고 있습니까?",
      description: "COSO Internal Control은 독립적 내부 감사 기능을 권장합니다.",
      options: ["예", "아니오"]
    },
    {
      id: 48,
      category: "Governance",
      subCategory: "Compliance Internal Control",
      text: "중요 의사결정은 문서로 기록되고 공개됩니까?",
      description: "투명한 기록 관리 체계는 책임성을 강화합니다.",
      options: ["예", "아니오"]
    },
    {
      id: 49,
      category: "Governance",
      subCategory: "Compliance Internal Control",
      text: "임직원 채용·승진 과정에서 내부 네트워크(친인척)의 영향을 배제합니까?",
      description: "공정한 인사 관리 원칙은 OECD 가이드라인에 포함됩니다.",
      options: ["예", "아니오"]
    },
    {
      id: 50,
      category: "Governance",
      subCategory: "Compliance Internal Control",
      text: "비재무적 위험(예: 평판 리스크)도 관리합니까?",
      description: "비재무 리스크 관리 여부는 기업 회복력과 직결됩니다.",
      options: ["예", "아니오"]
    },
    {
      id: 51,
      category: "Governance",
      subCategory: "Compliance Internal Control",
      text: "외부 전문가의 ESG 자문을 정기적으로 받습니까?",
      description: "전문 자문은 ESG 전략의 실행력을 높입니다.",
      options: ["예", "아니오"]
    },
    {
      id: 52,
      category: "Governance",
      subCategory: "Compliance Internal Control",
      text: "중요 감사 결과와 개선 권고 사항을 즉시 반영합니까?",
      description: "내부통제 효과성을 높이기 위해 신속한 개선이 필요합니다.",
      options: ["예", "아니오"]
    },
    {
      id: 53,
      category: "Governance",
      subCategory: "Compliance Internal Control",
      text: "법규 위반으로 인한 최근 제재 사례가 없습니까?",
      description: "법규 위반 여부는 기업의 준법 문화 수준을 반영합니다.",
      options: ["예", "아니오"]
    },
    {
      id: 54,
      category: "Governance",
      subCategory: "Compliance Internal Control",
      text: "내부 규정 위반 시 명확한 징계 절차가 적용됩니까?",
      description: "공정한 징계 절차는 규정 준수 문화를 강화합니다.",
      options: ["예", "아니오"]
    },
    {
      id: 55,
      category: "Governance",
      subCategory: "Compliance Internal Control",
      text: "경영 정보를 IT 시스템으로 관리하고 접근 권한을 통제합니까?",
      description: "정보 접근 통제는 내부통제 시스템의 핵심입니다.",
      options: ["예", "아니오"]
    },
  ]
};
