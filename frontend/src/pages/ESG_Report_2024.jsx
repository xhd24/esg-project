...
function ESG_Report_2024() {
    const [report, setReport] = useState(null);

    useEffect(() => {
        // ⭐️ localStorage 무시하고 강제로 더미 데이터 세팅
        setReport({
            scores: { total: 80, Environment: 25, Social: 30, Governance: 25 },
            yesCounts: { Environment: 10, Social: 15, Governance: 12 },
            noCounts: { Environment: 5, Social: 10, Governance: 8 },
            totals: { Environment: 15, Social: 25, Governance: 20 },
...
export default ESG_Report_2024;
